...
import com.example.retrofitcompose.data.RetrofitInstance
import com.example.retrofitcompose.data.models.CreatePostRequest
import com.example.retrofitcompose.data.models.Post
import com.example.retrofitcompose.data.models.User
import com.example.retrofitcompose.data.models.UserCreateRequest
...
class PostViewModel: ViewModel() {
    ...
    fun fetchPosts() {
        viewModelScope.launch {
            try {
                posts = RetrofitInstance.api.getPost(userId)
            } catch (e: Exception) {
                e.printStackTrace()
            }
        }
